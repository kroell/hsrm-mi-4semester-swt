...
/**
 * Klasse zum Einbinden einer installierten WebCam. Mit dieser
 * koennen Snapshot aufgenommen werden um sie spaeter als Avatar
 * Foto zu verwenden
 * 
 ...
 * 
 */
public class UseWebcam extends Object
{
    ...
    public static void main(final String[] args)
    {
        ...
        content.add(new JButton(new AbstractAction("Öffnen")
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                new Thread(new Runnable()
                {
                    public void run()
                    {
                        ...
                        try
                        {
                            webcam.open(new IWebcam.FrameFormat(240, 240), new IWebcam.IListener()
                            {
                                            ...
                                            switch (clickCount)
                                            {
                                                case 1:
                                                {
                                                    if (SwingUtilities.isRightMouseButton(e))
                                                    {
                                                        ...
                                                        popup.add(new AbstractAction("Fotografieren")
                                                        {
                                                        ...
                                                        popup.add(new AbstractAction("Bild spiegeln")
                                                        {
                                                            private final static long serialVersionUID = 0L;
                                                            
                                                            public void actionPerformed(ActionEvent e)
                                                            {
                                                                videoScreenMirror.set(!videoScreenMirror.get());
                                                                videoScreen.mirror(videoScreenMirror.get());
                                                            }
                                                        });
                                                        
                                                        popup.add(new AbstractAction("Bild umdrehen")
                                                        {
                                                            private final static long serialVersionUID = 0L;
                                                            
                                                            public void actionPerformed(ActionEvent e)
                                                            {
                                                                videoScreenFlip.set(!videoScreenFlip.get());
                                                                videoScreen.flip(videoScreenFlip.get());
                                                            }
                                                        });
        ...
        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        frame.setTitle("Mach ein Foto mit deiner Webcam!");
        ...
        webcamComboBox.setModel(new WebcamComboModel(WebcamFactory.getWebcams(frame, args.length == 0 ? "jitsi" : args[0])));
    }
