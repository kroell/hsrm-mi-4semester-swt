 ...
 * 
 * 
 * Panel zum Darstellen der Einstellungsmoeglichkeiten.
 * - Tastaturbelegung
 * - Laden eine neuen Map
 * 
...
public class SettingPanel extends javax.swing.JPanel {
    ...
    public SettingPanel(MainFrame mF) {
        ...
        io = mF.getGameEngine().getMapBuilder().getIO();
        oldMapPath = io.getMapPath();
        newMapPath = oldMapPath;
        loadPathInput.setText(oldMapPath);
    }
    ...
    private void initComponents() {
        ...
        loadPathBack = new javax.swing.JLabel();
        plusButton = new javax.swing.JButton();
        mapLoadHead = new javax.swing.JLabel();
        ...
        add(loadPathInput);
        loadPathInput.setBounds(100, 690, 290, 28);
        loadPathInput.setOpaque(false);
        loadPathInput.setBorder(BorderFactory.createLineBorder(Color.white, 0));
        loadPathInput.setBackground(null);
        
        loadPathBack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/repository/images/map_backblanko.png"))); // NOI18N
        add(loadPathBack);
        loadPathBack.setBounds(90, 690, 310, 28);
        ...
        add(plusButton);
        plusButton.setBounds(50, 690, 30, 29);

        mapLoadHead.setIcon(new javax.swing.ImageIcon(getClass().getResource("/repository/images/map_ladenNeueMap.png"))); // NOI18N
        add(mapLoadHead);
        mapLoadHead.setBounds(40, 650, 290, 20);
    ...
    private void mainMenuButtonActionPerformed(java.awt.event.ActionEvent evt) {
    	if (!oldMapPath.equalsIgnoreCase(newMapPath)){
    		loadPathInput.setText(io.getMapPath());
    	}
        try {
            mF.playSelectSound();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        // Laden der neuen Map und somit reset des gesamten Spiels mit der neuen Map
        if (!oldMapPath.equalsIgnoreCase(newMapPath)){
        	mF.getController().reset(newMapPath);
     ...
     * der die Erstauswahl auf .dat Dateien festlegt
     */
    public void loadMapFile() {
        // Initialisieren des FileChoosers
        fc = new JFileChooser();
        // Filter erzeugen, so dass nur .dat Files geladen werden koennen
        MyFileFilter fileFilter = new MyFileFilter("Map Dateien (map.dat)", new String[]{"map.dat"});
        ...
        if (retVal == JFileChooser.APPROVE_OPTION) {
            ...
            newMapPath = selectedFile.toString();
            loadPathInput.setText(newMapPath);
        }
    }

    private javax.swing.JLabel loadPathBack;
    private javax.swing.JTextField loadPathInput;
    private javax.swing.JButton mainMenuButton;
    private javax.swing.JLabel mapLoadHead;
